...
- created_gt (optional) -- Return logs created strictly after the given Unix Time (UTC) timestamp.
- created_gte (optional) -- Return logs created on or after the given Unix Time (UTC) timestamp.
- created_lt (optional) -- Return logs created strictly before the given Unix Time (UTC) timestamp.
- created_lte (optional) -- Return logs created on or before the given Unix Time (UTC) timestamp.
